...
#define GNOME_CANVAS_LINE_EXT(obj)				(GTK_CHECK_CAST ((obj), GNOME_TYPE_CANVAS_LINE_EXT, GnomeCanvasLineExt))
#define GNOME_CANVAS_LINE_EXT_CLASS(klass)		(GTK_CHECK_CLASS_CAST ((klass), GNOME_TYPE_CANVAS_LINE_EXT, GnomeCanvasLineExtClass))
#define GNOME_IS_CANVAS_LINE_EXT(obj)			(GTK_CHECK_TYPE ((obj), GNOME_TYPE_CANVAS_LINE_EXT))
#define GNOME_IS_CANVAS_LINE_EXT_CLASS(klass)	(GTK_CHECK_CLASS_TYPE ((klass), GNOME_TYPE_CANVAS_LINE_EXT))
#define GNOME_CANVAS_LINE_EXT_GET_CLASS(obj)	(GTK_CHECK_GET_CLASS ((obj), GNOME_TYPE_CANVAS_LINE_EXT, GnomeCanvasLineExtClass))
