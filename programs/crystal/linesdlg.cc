...
gcLinesDlg::gcLinesDlg (gcDocument* pDoc): gcDialog (DATADIR"/gcrystal-unstable/glade/lines.glade", "lines")
{
	...
	EdgesColor = (GtkColorButton *) glade_xml_get_widget (xml, "edges_color");
	...
	MediansColor = (GtkColorButton *) glade_xml_get_widget (xml, "med_color");
	...
	DiagsColor = (GtkColorButton *) glade_xml_get_widget (xml, "diag_color");
